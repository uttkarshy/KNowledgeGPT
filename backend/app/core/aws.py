...
def get_s3_client(settings: Settings):
    return boto3.client(
        ...
        endpoint_url=settings.AWS_S3_ENDPOINT_URL,  # None in prod -> real AWS
...
def generate_presigned_put_url(*, settings: Settings, key: str, content_type: str) -> str:
    """Returns a URL the FRONTEND uploads directly to — the file bytes never
    transit through our FastAPI/Celery processes, only S3 <-> browser."""
